...
logarithmic isotropic radius and contains values plus analytic first and second
radial derivatives for device-side quintic Hermite interpolation.
"""
...
def build_table(count: int, minimum_r: float, maximum_r: float):
    ...
    psi2 = areal / r
    psi2_d1 = areal_d1 / r - areal / r**2
    psi2_d2 = areal_d2 / r - 2.0 * areal_d1 / r**2 + 2.0 * areal / r**3
    ...
    return log_r, np.array([
        ...
        psi2, psi2_d1, psi2_d2,
        shift_q, shift_q_d1, shift_q_d2,
...
def write_header(path: Path, count: int, minimum_r: float, maximum_r: float):
    ...
    names = ("kTrumpetAlpha", "kTrumpetAlphaD1", "kTrumpetAlphaD2",
             "kTrumpetPsi2", "kTrumpetPsi2D1", "kTrumpetPsi2D2",
             "kTrumpetShiftQ", "kTrumpetShiftQD1", "kTrumpetShiftQD2")
