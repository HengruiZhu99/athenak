...
not established the published first peak, descent, deep minimum, or rebound in
central Kretschmann curvature versus central proper time.

## Qualification boundary

No claim is made for stability, Figure-3 reproduction, numerical failure, or
agreement with any published curve. Prior campaign results on the base branch
do not substitute for the missing fresh reference-gauge N256 run.
