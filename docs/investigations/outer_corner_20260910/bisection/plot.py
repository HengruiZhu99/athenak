...
ax.set(xlabel='Coordinate time (existing code units)',ylabel='Global minimum lapse',yscale='log',xlim=(0,200),title='N256 Brill-wave bisection: classification only at t=200')
