...
ax.set(xlabel='Coordinate time (existing code units)',ylabel='Global minimum lapse',yscale='log',xlim=(0,200),title='N256 Brill-wave bisection: early collapse below 1e-5; otherwise classify at t=200')
