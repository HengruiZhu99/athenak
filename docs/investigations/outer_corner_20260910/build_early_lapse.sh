...
root=/pscratch/sd/h/hzhu/corner-fix-tests-20260910/early-lapse
mkdir -p "$root/source"
tar -xzf /pscratch/sd/h/hzhu/corner-fix-tests-20260910/early-lapse-source.tar.gz -C "$root/source"
