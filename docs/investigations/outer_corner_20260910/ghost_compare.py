...
variants=[('sommerfeld_extrap2',[('z4c','extrap_order',2),('z4c','vc_single_rank_device_sync','true'),('output5','dt',1)]),('sommerfeld_extrap4',[('z4c','extrap_order',4),('z4c','vc_single_rank_device_sync','true'),('output5','dt',1)])]
for name,changes in variants:
 ...
 cmd=['srun','--nodes=1','--ntasks=1','--cpus-per-task=32','--gpus=1','--gpu-bind=single:1','--cpu-bind=cores','--exact',str(base/'athena.history_extrema'),'-r',str(rst),'-i',str(d/'input.athinput'),'-t','00:12:00']
 start=time.time()
