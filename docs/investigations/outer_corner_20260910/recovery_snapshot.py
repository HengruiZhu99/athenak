...
for name in sys.argv[1:]:
 ...
 if files:
  try:
   ...
   low=min(rows,key=lambda r:r['minLapse']);out['lowest_stored_lapse']=low['minLapse'];out['lowest_stored_lapse_time']=low['time'];out['recovery_armed_by_history']=low['minLapse']<.1
