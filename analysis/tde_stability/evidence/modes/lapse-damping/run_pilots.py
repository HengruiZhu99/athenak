...
import re,json,os,subprocess,concurrent.futures,hashlib,datetime
...
for block,k,v in [('time','tlim',300),('output4','dt',100),('mhd','debug_metric_before_c2p','true')]:base=setv(base,block,k,v)
cases=[('baseline',False,.1),('scaled_01',True,.1),('scaled_03',True,.3)]
def run(case):
