...
for case,label,color in [('theta_primary',r'$\eta=.02, d_\alpha=.01$ (cached primary)','C0'),('theta_lapse01',r'$\eta=.02, d_\alpha=.1$','C1')]:
 h=series('8842248',case,'user');c=series('8842248',case,'z4c')
 if h is None:continue
...
fig,axes=plt.subplots(1,3,figsize=(12,3.3),layout='constrained',facecolor='white')
for key,label in [('8842171-radial_k0','Lapse pulse'),('8842248-theta_primary',r'$\Theta$ pulse, $d_\alpha=.01$'),('8842248-theta_lapse01',r'$\Theta$ pulse, $d_\alpha=.1$')]:
 ds=profiles.get(key,[])
