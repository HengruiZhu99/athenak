...
void MeshRefinement::InitRecvAMR(int nleaf) {
  ...
  if (pmy_mesh->pmb_pack->pfogh != nullptr) {
    ncc_tosend += pmy_mesh->pmb_pack->pfogh->nfo_gh;
  }
...
void MeshRefinement::PackAndSendAMR(int nleaf) {
  ...
  fo_gh::FoGh* pfogh = pmy_mesh->pmb_pack->pfogh;
  ...
  if (pfogh != nullptr) {
    PackAMRBuffersCC(pfogh->u0, pfogh->coarse_u0, ncc_sent, nfc_sent);
    ncc_sent += pfogh->nfo_gh;
  }
...
void MeshRefinement::ClearRecvAndUnpackAMR() {
  ...
  if (pfogh != nullptr) {
    UnpackAMRBuffersCC(pfogh->u0, pfogh->coarse_u0, ncc_recv, nfc_recv);
    ncc_recv += pfogh->nfo_gh;
  }
#endif
  return;
}
