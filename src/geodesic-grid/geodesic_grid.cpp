...
GeodesicGrid::GeodesicGrid(int nlev, bool rotate, bool fluxes) :
  ...
  if (nlevel > 0) {  // construct geodesic mesh
    ...
    Real p3[3] = {Real(sin_ang*cos( 0.2*M_PI)),
                  Real(sin_ang*sin( 0.2*M_PI)), -cos_ang};
    Real p4[3] = {Real(sin_ang*cos(-0.4*M_PI)),
                  Real(sin_ang*sin(-0.4*M_PI)),  cos_ang};
    Real p5[3] = {Real(sin_ang*cos(-0.2*M_PI)),
                  Real(sin_ang*sin(-0.2*M_PI)), -cos_ang};
